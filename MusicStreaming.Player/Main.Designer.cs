namespace MusicStreaming.Player
{
	partial class Main
	{
		...
		private void InitializeComponent()
		{
			...
			panel8 = new Panel();
			panel11 = new Panel();
			trackBar = new ReaLTaiizor.Controls.HopeTrackBar();
			lbMaxTime = new Label();
			lbMinTime = new Label();
			panel10 = new Panel();
			...
			btnHome.Size = new Size(227, 48);
			btnHome.TabIndex = 1;
			btnHome.Tag = "Trang chủ";
			...
			panel2.Name = "panel2";
			panel2.Size = new Size(227, 23);
			panel2.TabIndex = 0;
			panel2.MouseDown += panelTitleBar_MouseDown;
			// 
			// panelTitleBar
			// 
			panelTitleBar.BackColor = Color.FromArgb(27, 28, 34);
			...
			panelTitleBar.Size = new Size(1268, 23);
			...
			btnMin.IconSize = 22;
			btnMin.Location = new Point(1160, 0);
			btnMin.Name = "btnMin";
			btnMin.Size = new Size(36, 23);
			btnMin.TabIndex = 2;
			...
			btnMax.IconSize = 22;
			btnMax.Location = new Point(1196, 0);
			btnMax.Name = "btnMax";
			btnMax.Size = new Size(36, 23);
			btnMax.TabIndex = 1;
			...
			btnExit.IconSize = 22;
			btnExit.Location = new Point(1232, 0);
			btnExit.Name = "btnExit";
			btnExit.Size = new Size(36, 23);
			btnExit.TabIndex = 0;
			...
			panel9.Location = new Point(227, 100);
			panel9.Name = "panel9";
			panel9.Size = new Size(27, 689);
			panel9.TabIndex = 4;
			// 
			// panelContainer
			// 
			...
			trackbarVolume.Location = new Point(56, 29);
			trackbarVolume.MaxValue = 100;
			...
			// panel11
			// 
			panel11.Controls.Add(trackBar);
			panel11.Controls.Add(lbMaxTime);
			panel11.Controls.Add(lbMinTime);
			...
			// trackBar
			// 
			trackBar.AlwaysValueVisible = false;
			trackBar.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
			trackBar.BallonArrowColor = Color.FromArgb(255, 128, 0);
			...
			trackBar.HeadBorderColor = Color.FromArgb(255, 128, 0);
			trackBar.HeadColor = Color.Black;
			trackBar.Location = new Point(95, 9);
			trackBar.MaxValue = 1000;
			trackBar.MinValue = 0;
			...
			// lbMaxTime
			// 
			lbMaxTime.Anchor = AnchorStyles.Top | AnchorStyles.Right;
			...
			lbMaxTime.Text = "00:00";
			// 
			// lbMinTime
			// 
			lbMinTime.Font = new Font("Open Sans", 10F, FontStyle.Regular, GraphicsUnit.Point);
			lbMinTime.ForeColor = Color.White;
			lbMinTime.Location = new Point(0, -2);
			lbMinTime.Name = "lbMinTime";
			lbMinTime.Size = new Size(70, 28);
			lbMinTime.TabIndex = 23;
			lbMinTime.Text = "00:00";
			lbMinTime.TextAlign = ContentAlignment.TopRight;
			// 
			// panel10
			// 
			...
			btnPlay.BorderCapStyle = System.Drawing.Drawing2D.DashCap.Flat;
			btnPlay.BorderColor = Color.RoyalBlue;
			btnPlay.BorderColor2 = Color.HotPink;
			...
			// lbSongArtist
			// 
			lbSongArtist.AutoSize = true;
			lbSongArtist.Font = new Font("Segoe UI", 10.2F, FontStyle.Regular, GraphicsUnit.Point);
			lbSongArtist.ForeColor = Color.White;
			lbSongArtist.Location = new Point(123, 64);
			lbSongArtist.Name = "lbSongArtist";
			lbSongArtist.Size = new Size(0, 30);
			lbSongArtist.TabIndex = 2;
			// 
			// lbSongName
			// 
			lbSongName.AutoSize = true;
			lbSongName.Font = new Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point);
			lbSongName.ForeColor = Color.White;
			lbSongName.Location = new Point(123, 29);
			lbSongName.Name = "lbSongName";
			lbSongName.Size = new Size(0, 32);
			lbSongName.TabIndex = 1;
			// 
			// pbSong
			// 
			pbSong.Dock = DockStyle.Left;
			pbSong.Location = new Point(0, 0);
			pbSong.Name = "pbSong";
			pbSong.Size = new Size(117, 110);
			...
			tableLayoutPanel1.Location = new Point(0, 789);
